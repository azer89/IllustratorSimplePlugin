...
QT_MOC_LITERAL(1, 9, 13), // "QtSendMessage"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 3) // "msg"

    },
    "GLWidget\0QtSendMessage\0\0msg"
};
...
void GLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->QtSendMessage((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GLWidget::QtSendMessage)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void GLWidget::QtSendMessage(QString _t1)
{
